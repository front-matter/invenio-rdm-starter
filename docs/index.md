...
InvenioRDM Starter uses Python 3.13 ([the current version](https://devguide.python.org/versions/)), but doesn't use any features of Python 3.10-3.13. Please report any Python 3.13-related issues you encounter. Python 3.9 reaches end-of-life in October 2025.
