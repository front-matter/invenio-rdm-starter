...
* a Docker Compose configuration file with sensible defaults and detailed documentation.
...
The `compose.yml` file is well documented, and the documentation is also available online at [https://starter.front-matter.de/](https://starter.front-matter.de/) using the Envy documentation tool.
